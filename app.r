...
library(here)
## ------------------------------------------------------------------------
kanewaisp_condata <- read.csv(here("data/data_conductivity_Calibrated_temp_AprJuly2025_KanewaiSpringRock_21415544 - data_conductivity_Calibrated_temp_AprJuly2025_KanewaiSpringRock_21415544.csv"))

kalaug_condata <- read.csv(here("data/kalauhaihai_garage_conductivity_data.csv"))
